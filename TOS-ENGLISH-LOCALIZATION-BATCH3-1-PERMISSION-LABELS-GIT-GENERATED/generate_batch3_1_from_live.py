...
EXPECTED_HEAD = "c03aecaa14a2133ca1adb3bb4dad6c07e91a0664"
...
def main():
    if len(sys.argv) != 3:
        die("usage: generate_batch3_1_from_live.py REPO_ROOT OUTPUT_PATCH", 2)
    ...
    tmp = Path(tempfile.mkdtemp(prefix="tos-batch3-1-"))
    try:
        run(["git", "init", "-q"], tmp)
